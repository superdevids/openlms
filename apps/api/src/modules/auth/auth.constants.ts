...
export const ACCESS_COOKIE_NAME = "opensis_access";
export const REFRESH_COOKIE_NAME = "opensis_refresh";

/**
 * Cookie sesi alias (G-04): web proxy (apps/web/src/proxy.ts) memeriksa
 * `opensis_session` untuk proteksi halaman; AuthGuard juga membaca cookie ini
 * lebih dulu. Backend men-set cookie ini = access token agar kedua jalur
 * (proxy UX + otorisasi API) konsisten.
 */
export const SESSION_COOKIE_NAME = "opensis_session";
