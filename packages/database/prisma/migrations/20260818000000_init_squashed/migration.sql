...
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SISWA', 'GURU', 'BK', 'KAPRODI', 'KEUANGAN', 'OPERATOR', 'WAKEPSEK', 'KEPSEK', 'AUDITOR', 'SUPERADMIN', 'CALON_SISWA', 'WALI_MURID', 'PEMBIMBING_INDUSTRI', 'PENGUJI_EKSTERNAL');
...
-- CreateEnum
CREATE TYPE "InvoiceType" AS ENUM ('SPP', 'UANG_KEGIATAN', 'UANG_DAFTAR', 'UANG_SERAGAM', 'UANG_OSIS', 'DENDA', 'LAINNYA');
...
-- CreateEnum
CREATE TYPE "AssetCategory" AS ENUM ('RUANG', 'LAB', 'ALAT', 'KENDARAAN', 'PERALATAN_IT', 'LAINNYA');
...
-- CreateEnum
CREATE TYPE "ExportType" AS ENUM ('DAPODIK', 'ANBK', 'RAPOR', 'NILAI', 'PERSONAL');

-- CreateEnum
CREATE TYPE "PdpRequestType" AS ENUM ('DELETE', 'EXPORT');

-- CreateEnum
CREATE TYPE "PdpRequestStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'EXECUTED');
...
CREATE TABLE "rapor_p5" (
    ...
    CONSTRAINT "rapor_p5_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "staff" (
    ...
    "ter_category" TEXT NOT NULL DEFAULT 'A',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "pdp_request" (
    "id" TEXT NOT NULL,
    "user_id" TEXT NOT NULL,
    "type" "PdpRequestType" NOT NULL,
    "status" "PdpRequestStatus" NOT NULL DEFAULT 'PENDING',
    "reason" TEXT,
    ...
    CONSTRAINT "pdp_request_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "grade_academic_year_student_id_idx" ON "grade"("academic_year", "student_id");
...
-- CreateIndex
CREATE INDEX "rapor_p5_student_id_semester_academic_year_idx" ON "rapor_p5"("student_id", "semester", "academic_year");

-- CreateIndex
CREATE UNIQUE INDEX "rapor_p5_student_id_semester_academic_year_project_name_key" ON "rapor_p5"("student_id", "semester", "academic_year", "project_name");
...
-- CreateIndex
CREATE INDEX "pdp_request_user_id_status_idx" ON "pdp_request"("user_id", "status");

-- CreateIndex
CREATE INDEX "pdp_request_status_idx" ON "pdp_request"("status");
...
-- AddForeignKey
ALTER TABLE "rapor_p5" ADD CONSTRAINT "rapor_p5_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "rapor_p5" ADD CONSTRAINT "rapor_p5_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "pdp_request" ADD CONSTRAINT "pdp_request_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pdp_request" ADD CONSTRAINT "pdp_request_processed_by_fkey" FOREIGN KEY ("processed_by") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
